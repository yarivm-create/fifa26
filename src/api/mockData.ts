...
const MATCHES: Match[] = [
  ...
  { id: 74, venue: 'Houston Stadium', location: 'Houston, USA', datetime: '2026-06-29T17:00:00Z', status: 'future_scheduled', stage_name: 'Round of 32', home_team: { country: '1C', name: '1C', code: '1C', goals: null }, away_team: { country: '2F', name: '2F', code: '2F', goals: null } },
  { id: 75, venue: 'Boston Stadium', location: 'Boston, USA', datetime: '2026-06-29T20:30:00Z', status: 'future_scheduled', stage_name: 'Round of 32', home_team: { country: 'Germany', name: 'Germany', code: 'GER', goals: null }, away_team: { country: '3ABCDF', name: '3ABCDF', code: '3ABCDF', goals: null } },
  { id: 76, venue: 'Monterrey Stadium', location: 'Monterrey, Mexico', datetime: '2026-06-30T01:00:00Z', status: 'future_scheduled', stage_name: 'Round of 32', home_team: { country: '1F', name: '1F', code: '1F', goals: null }, away_team: { country: '2C', name: '2C', code: '2C', goals: null } },
  { id: 77, venue: 'Dallas Stadium', location: 'Dallas, USA', datetime: '2026-06-30T17:00:00Z', status: 'future_scheduled', stage_name: 'Round of 32', home_team: { country: '2E', name: '2E', code: '2E', goals: null }, away_team: { country: '2I', name: '2I', code: '2I', goals: null } },
  { id: 78, venue: 'New York/New Jersey Stadium', location: 'New Jersey, USA', datetime: '2026-06-30T21:00:00Z', status: 'future_scheduled', stage_name: 'Round of 32', home_team: { country: '1I', name: '1I', code: '1I', goals: null }, away_team: { country: '3CDFGH', name: '3CDFGH', code: '3CDFGH', goals: null } },
  { id: 79, venue: 'Mexico City Stadium', location: 'Mexico City, Mexico', datetime: '2026-07-01T01:00:00Z', status: 'future_scheduled', stage_name: 'Round of 32', home_team: { country: 'Mexico', name: 'Mexico', code: 'MEX', goals: null }, away_team: { country: '3CEFHI', name: '3CEFHI', code: '3CEFHI', goals: null } },
  ...
  { id: 81, venue: 'Seattle Stadium', location: 'Seattle, USA', datetime: '2026-07-01T20:00:00Z', status: 'future_scheduled', stage_name: 'Round of 32', home_team: { country: '1G', name: '1G', code: '1G', goals: null }, away_team: { country: '3AEHIJ', name: '3AEHIJ', code: '3AEHIJ', goals: null } },
  { id: 82, venue: 'San Francisco Bay Area Stadium', location: 'San Francisco, USA', datetime: '2026-07-02T00:00:00Z', status: 'future_scheduled', stage_name: 'Round of 32', home_team: { country: 'United States', name: 'United States', code: 'USA', goals: null }, away_team: { country: '3BEFIJ', name: '3BEFIJ', code: '3BEFIJ', goals: null } },
  { id: 83, venue: 'Los Angeles Stadium', location: 'Los Angeles, USA', datetime: '2026-07-02T19:00:00Z', status: 'future_scheduled', stage_name: 'Round of 32', home_team: { country: '1H', name: '1H', code: '1H', goals: null }, away_team: { country: '2J', name: '2J', code: '2J', goals: null } },
  { id: 84, venue: 'Toronto Stadium', location: 'Toronto, Canada', datetime: '2026-07-02T23:00:00Z', status: 'future_scheduled', stage_name: 'Round of 32', home_team: { country: '2K', name: '2K', code: '2K', goals: null }, away_team: { country: '2L', name: '2L', code: '2L', goals: null } },
  ...
  { id: 86, venue: 'Dallas Stadium', location: 'Dallas, USA', datetime: '2026-07-03T18:00:00Z', status: 'future_scheduled', stage_name: 'Round of 32', home_team: { country: '2D', name: '2D', code: '2D', goals: null }, away_team: { country: '2G', name: '2G', code: '2G', goals: null } },
  { id: 87, venue: 'Miami Stadium', location: 'Miami, USA', datetime: '2026-07-03T22:00:00Z', status: 'future_scheduled', stage_name: 'Round of 32', home_team: { country: '1J', name: '1J', code: '1J', goals: null }, away_team: { country: '2H', name: '2H', code: '2H', goals: null } },
  { id: 88, venue: 'Kansas City Stadium', location: 'Kansas City, USA', datetime: '2026-07-04T01:30:00Z', status: 'future_scheduled', stage_name: 'Round of 32', home_team: { country: '1K', name: '1K', code: '1K', goals: null }, away_team: { country: '3DEIJL', name: '3DEIJL', code: '3DEIJL', goals: null } },

  // ROUND OF 16
  { id: 89, venue: 'Houston Stadium', location: 'Houston, USA', datetime: '2026-07-04T17:00:00Z', status: 'future_scheduled', stage_name: 'Round of 16', home_team: { country: 'W73', name: 'W73', code: 'W73', goals: null }, away_team: { country: 'W75', name: 'W75', code: 'W75', goals: null } },
  { id: 90, venue: 'Philadelphia Stadium', location: 'Philadelphia, USA', datetime: '2026-07-04T21:00:00Z', status: 'future_scheduled', stage_name: 'Round of 16', home_team: { country: 'W74', name: 'W74', code: 'W74', goals: null }, away_team: { country: 'W77', name: 'W77', code: 'W77', goals: null } },
