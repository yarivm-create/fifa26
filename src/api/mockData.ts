...
const MATCHES: Match[] = [
  // ── June 22 (Mon) Israel ──
  { id: 200, venue: 'AT&T Stadium', location: 'Dallas, USA', datetime: '2026-06-22T17:00:00Z', status: 'future_scheduled', stage_name: 'Group J - MD2', home_team: { country: 'Argentina', name: 'Argentina', code: 'ARG', goals: null }, away_team: { country: 'Austria', name: 'Austria', code: 'AUT', goals: null }, group: 'J' }, // 20:00 IL
  { id: 201, venue: 'Lincoln Financial Field', location: 'Philadelphia, USA', datetime: '2026-06-22T20:00:00Z', status: 'future_scheduled', stage_name: 'Group I - MD2', home_team: { country: 'France', name: 'France', code: 'FRA', goals: null }, away_team: { country: 'Iraq', name: 'Iraq', code: 'IRQ', goals: null }, group: 'I' }, // 23:00 IL
  { id: 202, venue: 'MetLife Stadium', location: 'East Rutherford, USA', datetime: '2026-06-22T23:00:00Z', status: 'future_scheduled', stage_name: 'Group I - MD2', home_team: { country: 'Norway', name: 'Norway', code: 'NOR', goals: null }, away_team: { country: 'Senegal', name: 'Senegal', code: 'SEN', goals: null }, group: 'I' }, // 02:00 IL Tue
  { id: 203, venue: "Levi's Stadium", location: 'Santa Clara, USA', datetime: '2026-06-23T02:00:00Z', status: 'future_scheduled', stage_name: 'Group J - MD2', home_team: { country: 'Jordan', name: 'Jordan', code: 'JOR', goals: null }, away_team: { country: 'Algeria', name: 'Algeria', code: 'ALG', goals: null }, group: 'J' }, // 05:00 IL Tue
  ...
  { id: 300, venue: 'NRG Stadium', location: 'Houston, USA', datetime: '2026-06-23T15:00:00Z', status: 'future_scheduled', stage_name: 'Group K - MD2', home_team: { country: 'Portugal', name: 'Portugal', code: 'POR', goals: null }, away_team: { country: 'Uzbekistan', name: 'Uzbekistan', code: 'UZB', goals: null }, group: 'K' }, // 18:00 IL
  { id: 301, venue: 'Gillette Stadium', location: 'Foxborough, USA', datetime: '2026-06-23T18:00:00Z', status: 'future_scheduled', stage_name: 'Group L - MD2', home_team: { country: 'England', name: 'England', code: 'ENG', goals: null }, away_team: { country: 'Ghana', name: 'Ghana', code: 'GHA', goals: null }, group: 'L' }, // 21:00 IL
  { id: 302, venue: 'BMO Field', location: 'Toronto, Canada', datetime: '2026-06-23T21:00:00Z', status: 'future_scheduled', stage_name: 'Group L - MD2', home_team: { country: 'Panama', name: 'Panama', code: 'PAN', goals: null }, away_team: { country: 'Croatia', name: 'Croatia', code: 'CRO', goals: null }, group: 'L' }, // 00:00 IL Wed
  { id: 303, venue: 'Estadio Akron', location: 'Guadalajara, Mexico', datetime: '2026-06-24T00:00:00Z', status: 'future_scheduled', stage_name: 'Group K - MD2', home_team: { country: 'Colombia', name: 'Colombia', code: 'COL', goals: null }, away_team: { country: 'DR Congo', name: 'DR Congo', code: 'COD', goals: null }, group: 'K' }, // 03:00 IL Wed

  // ── Upcoming — June 24 (Wed) Israel ──
  { id: 310, venue: 'BC Place', location: 'Vancouver, Canada', datetime: '2026-06-24T15:00:00Z', status: 'future_scheduled', stage_name: 'Group B - MD3', home_team: { country: 'Switzerland', name: 'Switzerland', code: 'SUI', goals: null }, away_team: { country: 'Canada', name: 'Canada', code: 'CAN', goals: null }, group: 'B' }, // 18:00 IL
  { id: 311, venue: 'Lumen Field', location: 'Seattle, USA', datetime: '2026-06-24T15:00:00Z', status: 'future_scheduled', stage_name: 'Group B - MD3', home_team: { country: 'Bosnia & Herzegovina', name: 'Bosnia & Herzegovina', code: 'BIH', goals: null }, away_team: { country: 'Qatar', name: 'Qatar', code: 'QAT', goals: null }, group: 'B' }, // 18:00 IL
  { id: 312, venue: 'Hard Rock Stadium', location: 'Miami, USA', datetime: '2026-06-24T18:00:00Z', status: 'future_scheduled', stage_name: 'Group C - MD3', home_team: { country: 'Scotland', name: 'Scotland', code: 'SCO', goals: null }, away_team: { country: 'Brazil', name: 'Brazil', code: 'BRA', goals: null }, group: 'C' }, // 21:00 IL
  { id: 313, venue: 'Mercedes-Benz Stadium', location: 'Atlanta, USA', datetime: '2026-06-24T18:00:00Z', status: 'future_scheduled', stage_name: 'Group C - MD3', home_team: { country: 'Morocco', name: 'Morocco', code: 'MAR', goals: null }, away_team: { country: 'Haiti', name: 'Haiti', code: 'HAI', goals: null }, group: 'C' }, // 21:00 IL
  { id: 314, venue: 'Estadio Banorte', location: 'Monterrey, Mexico', datetime: '2026-06-24T21:00:00Z', status: 'future_scheduled', stage_name: 'Group A - MD3', home_team: { country: 'Czechia', name: 'Czechia', code: 'CZE', goals: null }, away_team: { country: 'Mexico', name: 'Mexico', code: 'MEX', goals: null }, group: 'A' }, // 00:00 IL Thu
  { id: 315, venue: 'Estadio BBVA', location: 'Guadalupe, Mexico', datetime: '2026-06-24T21:00:00Z', status: 'future_scheduled', stage_name: 'Group A - MD3', home_team: { country: 'South Africa', name: 'South Africa', code: 'RSA', goals: null }, away_team: { country: 'South Korea', name: 'South Korea', code: 'KOR', goals: null }, group: 'A' }, // 00:00 IL Thu

  // ── Upcoming — June 25 (Thu) Israel ──
  { id: 320, venue: 'Lincoln Financial Field', location: 'Philadelphia, USA', datetime: '2026-06-25T17:00:00Z', status: 'future_scheduled', stage_name: 'Group E - MD3', home_team: { country: 'Curaçao', name: 'Curaçao', code: 'CUW', goals: null }, away_team: { country: "Côte d'Ivoire", name: "Côte d'Ivoire", code: 'CIV', goals: null }, group: 'E' }, // 20:00 IL
  { id: 321, venue: 'MetLife Stadium', location: 'East Rutherford, USA', datetime: '2026-06-25T17:00:00Z', status: 'future_scheduled', stage_name: 'Group E - MD3', home_team: { country: 'Ecuador', name: 'Ecuador', code: 'ECU', goals: null }, away_team: { country: 'Germany', name: 'Germany', code: 'GER', goals: null }, group: 'E' }, // 20:00 IL
  { id: 322, venue: 'AT&T Stadium', location: 'Arlington, USA', datetime: '2026-06-25T20:00:00Z', status: 'future_scheduled', stage_name: 'Group F - MD3', home_team: { country: 'Japan', name: 'Japan', code: 'JPN', goals: null }, away_team: { country: 'Sweden', name: 'Sweden', code: 'SWE', goals: null }, group: 'F' }, // 23:00 IL
  { id: 323, venue: 'GEHA Field', location: 'Kansas City, USA', datetime: '2026-06-25T20:00:00Z', status: 'future_scheduled', stage_name: 'Group F - MD3', home_team: { country: 'Tunisia', name: 'Tunisia', code: 'TUN', goals: null }, away_team: { country: 'Netherlands', name: 'Netherlands', code: 'NED', goals: null }, group: 'F' }, // 23:00 IL
  { id: 324, venue: "Levi's Stadium", location: 'Santa Clara, USA', datetime: '2026-06-25T23:00:00Z', status: 'future_scheduled', stage_name: 'Group D - MD3', home_team: { country: 'Paraguay', name: 'Paraguay', code: 'PAR', goals: null }, away_team: { country: 'Australia', name: 'Australia', code: 'AUS', goals: null }, group: 'D' }, // 02:00 IL Fri
  { id: 325, venue: 'SoFi Stadium', location: 'Inglewood, USA', datetime: '2026-06-25T23:00:00Z', status: 'future_scheduled', stage_name: 'Group D - MD3', home_team: { country: 'Türkiye', name: 'Türkiye', code: 'TUR', goals: null }, away_team: { country: 'United States', name: 'United States', code: 'USA', goals: null }, group: 'D' }, // 02:00 IL Fri
];
