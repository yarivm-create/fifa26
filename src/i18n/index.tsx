...
const en: Dict = {
  ...
  'fav.emptyHint': "Tap ☆ next to a team in the Standings tab to follow a team, or next to a player in the Stats tab to follow a player. They'll show up here.",
  'fav.teams': '⭐ Favorite Teams',
  'fav.players': '👤 Followed Players',
  'fav.teamsPrompt': 'Tap ☆ next to a team in the Standings tab to add it here.',
...
const he: Dict = {
  ...
  'fav.emptyHint': 'הקישו על ☆ ליד קבוצה בלשונית הטבלאות כדי לעקוב אחר קבוצה, או ליד שחקן בלשונית הסטטיסטיקה כדי לעקוב אחר שחקן. הם יופיעו כאן.',
  'fav.teams': '⭐ קבוצות מועדפות',
  'fav.players': '👤 שחקנים שאני עוקב אחריהם',
  'fav.teamsPrompt': 'הקישו על ☆ ליד קבוצה בלשונית הטבלאות כדי להוסיף אותה לכאן.',
