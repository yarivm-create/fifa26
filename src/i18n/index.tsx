...
const en: Dict = {
  ...
  // Live Match Bar
  'live.bar.regionLabel': 'Live match',
  'live.bar.detailsLabel': 'Live match details',
  'live.bar.aria': 'Live match: {home} {hg}, {away} {ag}. {status}. Activate to expand.',
  'live.bar.srScore': '{home} {hg}, {away} {ag}. {status}',
  'live.bar.live': 'LIVE',
  'live.bar.close': 'Close live match details',
  'live.bar.next': 'Next live match',
  'live.bar.openMatch': 'Open full match',
  'live.bar.follow': 'Follow match',
  'live.bar.following': 'Following',
  'live.bar.notifyTitle': 'Notifications',
  'live.bar.enableNotifications': 'Enable notifications',
  'live.bar.notificationsBlocked': 'Notifications are blocked in your browser settings.',
  'live.bar.notifUnsupported': 'Notifications aren’t supported on this device.',
  'live.bar.notifNote': 'You’ll get alerts for this match while the site is open.',
  'live.bar.updated': 'Updated {time}',
  'live.bar.reconnecting': 'Reconnecting…',
  'live.bar.ended': 'FULL TIME',
  'live.bar.events': 'Match events',
  'live.bar.noEvents': 'No events yet — updates appear live.',
  // Live event feed
  'live.ev.goal': '⚽ Goal — {team}',
  'live.ev.penaltyScore': '⚽ Penalty scored — {team}',
  'live.ev.penaltyMiss': '❌ Penalty missed — {team}',
  'live.ev.yellowCard': '🟨 Yellow card — {team}',
  'live.ev.redCard': '🟥 Red card — {team}',
  'live.ev.substitution': '🔄 Substitution',
  'live.ev.var': '📺 VAR',
  'live.ev.kickoff': '🟢 Kick-off',
  'live.ev.halfTime': '⏸️ Half-time',
  'live.ev.secondHalf': '▶️ Second half',
  'live.ev.extraTime': '⏱️ Extra time',
  'live.ev.penaltyShootout': '🥅 Penalty shootout',
  'live.ev.fullTime': '🏁 Full-time',
  // Notifications
  'notify.goal': '⚽ GOAL — {team}',
  'notify.redCard': '🟥 Red card — {team}',
  'notify.kickoff': '🟢 Kick-off',
  'notify.halfTime': '⏸️ Half-time',
  'notify.fullTime': '🏁 Full-time',
  'notify.penaltyShootout': '🥅 Penalty shootout',
  'notify.cat.goals': 'Goals',
  'notify.cat.cards': 'Red cards',
  'notify.cat.kickoff': 'Kick-off',
  'notify.cat.halfTime': 'Half-time',
  'notify.cat.fullTime': 'Full-time',
  'notify.cat.penaltyShootout': 'Penalty shootout',
};
...
const he: Dict = {
  ...
  'status.pensLive': 'פנדלים {h}-{a}',
  'status.prePenalties': 'פנדלים בקרוב',
  'status.extraTime': 'הארכה',
  'status.etLive': 'הארכה {min}',
  'status.etHalfTime': 'מחצית הארכה',
  ...
  // Live Match Bar
  'live.bar.regionLabel': 'משחק חי',
  'live.bar.detailsLabel': 'פרטי משחק חי',
  'live.bar.aria': 'משחק חי: {home} {hg}, {away} {ag}. {status}. הפעילו כדי להרחיב.',
  'live.bar.srScore': '{home} {hg}, {away} {ag}. {status}',
  'live.bar.live': 'חי',
  'live.bar.close': 'סגירת פרטי המשחק החי',
  'live.bar.next': 'המשחק החי הבא',
  'live.bar.openMatch': 'פתחו את המשחק המלא',
  'live.bar.follow': 'עקבו אחר המשחק',
  'live.bar.following': 'עוקב',
  'live.bar.notifyTitle': 'התראות',
  'live.bar.enableNotifications': 'הפעלת התראות',
  'live.bar.notificationsBlocked': 'ההתראות חסומות בהגדרות הדפדפן.',
  'live.bar.notifUnsupported': 'התראות אינן נתמכות במכשיר זה.',
  'live.bar.notifNote': 'תקבלו התראות על המשחק הזה כל עוד האתר פתוח.',
  'live.bar.updated': 'עודכן {time}',
  'live.bar.reconnecting': 'מתחבר מחדש…',
  'live.bar.ended': 'סיום',
  'live.bar.events': 'אירועי המשחק',
  'live.bar.noEvents': 'אין עדיין אירועים — עדכונים יופיעו בזמן אמת.',
  // Live event feed
  'live.ev.goal': '⚽ גול — {team}',
  'live.ev.penaltyScore': '⚽ פנדל הובקע — {team}',
  'live.ev.penaltyMiss': '❌ פנדל הוחמץ — {team}',
  'live.ev.yellowCard': '🟨 כרטיס צהוב — {team}',
  'live.ev.redCard': '🟥 כרטיס אדום — {team}',
  'live.ev.substitution': '🔄 חילוף',
  'live.ev.var': '📺 VAR',
  'live.ev.kickoff': '🟢 שריקת פתיחה',
  'live.ev.halfTime': '⏸️ מחצית',
  'live.ev.secondHalf': '▶️ מחצית שנייה',
  'live.ev.extraTime': '⏱️ הארכה',
  'live.ev.penaltyShootout': '🥅 פנדלים',
  'live.ev.fullTime': '🏁 סיום',
  // Notifications
  'notify.goal': '⚽ גול — {team}',
  'notify.redCard': '🟥 כרטיס אדום — {team}',
  'notify.kickoff': '🟢 שריקת פתיחה',
  'notify.halfTime': '⏸️ מחצית',
  'notify.fullTime': '🏁 סיום',
  'notify.penaltyShootout': '🥅 פנדלים',
  'notify.cat.goals': 'שערים',
  'notify.cat.cards': 'כרטיסים אדומים',
  'notify.cat.kickoff': 'שריקת פתיחה',
  'notify.cat.halfTime': 'מחצית',
  'notify.cat.fullTime': 'סיום',
  'notify.cat.penaltyShootout': 'פנדלים',
};
